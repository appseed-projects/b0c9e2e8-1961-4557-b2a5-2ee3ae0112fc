...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-06 20:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b0c9e2e8-1961-4557-b2a5-2ee3ae0112fc.git
$ cd b0c9e2e8-1961-4557-b2a5-2ee3ae0112fc
```
